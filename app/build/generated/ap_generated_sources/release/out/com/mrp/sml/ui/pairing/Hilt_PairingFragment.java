...
abstract class Hilt_PairingFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PairingFragment() {
    super();
  }

  Hilt_PairingFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PairingFragment_GeneratedInjector) this.generatedComponent()).injectPairingFragment(UnsafeCasts.<PairingFragment>unsafeCast(this));
    }
  }
