...
public final class DaggerSmlApplication_HiltComponents_SingletonC {
  ...
  private static final class ViewModelCImpl extends SmlApplication_HiltComponents.ViewModelC {
    ...
    private ConnectionUseCase connectionUseCase() {
      return new ConnectionUseCase(singletonCImpl.provideDeviceConnectionRepositoryProvider.get());
    }

    private ObserveTransferHistoryUseCase observeTransferHistoryUseCase() {
      return new ObserveTransferHistoryUseCase(singletonCImpl.provideTransferHistoryRepositoryProvider.get());
    }

    private FileTransferUseCase fileTransferUseCase() {
      return new FileTransferUseCase(singletonCImpl.provideFileTransferRepositoryProvider.get());
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) new ConnectionViewModel(viewModelCImpl.connectionUseCase());
  ...
  private static final class SingletonCImpl extends SmlApplication_HiltComponents.SingletonC {
    ...
    private TransferDao transferDao() {
      return DataModule_ProvideTransferDaoFactory.provideTransferDao(provideSmlDatabaseProvider.get());
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) DataModule_ProvideTransferHistoryRepositoryFactory.provideTransferHistoryRepository(singletonCImpl.transferDao(), singletonCImpl.defaultDispatchersProvider.get());
